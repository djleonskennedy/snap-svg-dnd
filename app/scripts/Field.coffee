define ['Snap', 'DropArea', 'Handler', 'DragAndDropBindings', 'Path'], (Snap, DropArea, Handler, DragAndDropBindings, Path)->
  class Field
    ...
    initialization: ->
      ...
      binding01.registerArea new DropArea(@paper.circle(0, 0, 60), @paper.circle(0, 0, 5)).draw(500, 600)
      ...
      binding01.registerHandler new Handler(@paper.group(@paper.circle(0, 0, 10), @paper.circle(0, 0, 50))).draw(300, 50)
